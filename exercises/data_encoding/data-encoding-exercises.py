...
# with open("ford_escort.csv", "r") as ford_escort:
#   for row in csv.reader(ford_escort):
#        print(row)

# 2. Extend the above so that the data is read into a dictionary.

# with open("ford_escort.csv", "r") as ford_escort:
#   for row in csv.DictReader(ford_escort):
#        print(row)
...
# with open("new_name.csv" "w") as new_names:
...
with open("menu_items.json", "r") as menu_items:
    men_items = json.load(menu_items)
    print(men_items)
